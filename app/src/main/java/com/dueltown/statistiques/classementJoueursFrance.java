...
import com.dueltown.affichagesListes.AdapterClassementJoueursFrance;
...
public class classementJoueursFrance extends AppCompatActivity {
    ...
    private AdapterClassementJoueursFrance mAdapter;
    ...
    private void recupClassement() {
        ...
        mAdapter = new AdapterClassementJoueursFrance(listeclassement);
        ...
        service.classementjoueursfrance("classementJoueurFrance").enqueue(new Callback<List<BDD>>() {
            @Override
